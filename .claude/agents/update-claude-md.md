...
2. Read key source files: `frontend/src/js/types.d.ts`, `frontend/src/js/data.ts`, `frontend/src/js/nav.ts`, `frontend/src/js/app.ts`, `frontend/src/js/nav.test.ts`, `backend/db.go`, `backend/feed.go`, `backend/feed.go`
